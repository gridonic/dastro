...
export function buildDastroContext<T extends DastroTypes>(
  ...
  return {
    ...
    translations: (siteLocale: T['SiteLocale']) =>
      translations(dastroConfig, siteLocale),
    page: () => page(dastroConfig),
